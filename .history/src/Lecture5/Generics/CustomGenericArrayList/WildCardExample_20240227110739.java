...
public class WildCardExample<T extends Number> {
    ...
    public void getList(List<Number> list) {
        ...
        // Number.// List<Number> can hold any Number type (Integer, Double, Float, etc.).
// You can add any Number type to this list and get elements from the list as Number.
...
List<? extends Number> list2 = new ArrayList<>();
    ...
    public void getListAndTypes(List<? extends Number> list) {
        // here you can pass Number as well as int, float, etc.
    }
