...
public class WildCardExample<T extends Number> {
    ...
    public void getListAndTypes(List<? extends Number> list) {
        // List<? extends Number> can hold a specific subtype of Number (like Integer or
        // Double),
        // but we don't know which subtype. You cannot add any element to this list
        // (except for null),
        // because the list's element type could be any subtype of Number. However, you
        // can get elements from the list as Number.
    }
